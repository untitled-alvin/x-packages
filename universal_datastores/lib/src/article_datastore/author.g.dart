...
Author deserializeAuthor(IsarReader reader) {
  ...
  final String? _image;
  _image = IsarCore.readString(reader, 2);
  final object = Author(
    name: _name,
    image: _image,
  );
...
extension AuthorQueryFilter on QueryBuilder<Author, Author, QFilterCondition> {
  ...
  QueryBuilder<Author, Author, QAfterFilterCondition> imageGreaterThanOrEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Author, Author, QAfterFilterCondition> imageLessThanOrEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
